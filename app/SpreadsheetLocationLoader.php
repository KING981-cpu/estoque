...
class SpreadsheetLocationLoader
{
    ...
    private function cleanLabel(string $text): string
    {
        ...
        return $this->correctLabel($clean);
    }

    private function correctLabel(string $text): string
    {
        $corrections = [
            ...
            'Setor de Formação e Capacitação Digita' => 'Setor de Formação e Capacitação Digital',
